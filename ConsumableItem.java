...
//Purpose: This class defines what an consumable item is within the overall class of items.
...
public class ConsumableItem implements Consumable
{
    ...
    ConsumableItem(String itemName, int itemId, String itemDetails
            , String itemEffect, int cooldown, String requirements)
    {
